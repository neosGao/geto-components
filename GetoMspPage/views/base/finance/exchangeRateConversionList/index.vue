 ...
 * @LastEditTime: 2023-11-29 15:28:28
 * @FilePath: src\views\page\finance\exchangeRateList\index.vue
 * @Description: 外币转化管理-列表
 *
...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/exchangeRateConversionList";
...
const init_data_config = {
  title: "外币转化管理",
  url: "/api/msp-helper/publicbasicdata/exchange-rate-conversion/index",
  method: "POST",
  task_class: "ExchangeRateConversionExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_EXCHANGE_RATE_CONVERSION_MANAGEMENT_EXPORT",
  useSelection: false,
  useIndex: true
};

 ...
 * @FilePath: src\geto-components\GetoMspPage\views\base\finance\taxRateList\index.vue
 * @Description: 税率列表-列表
 *
...
const init_data_config = {
  title: "税率列表",
  url: "/api/msp-helper/publicbasicdata/tax-rate/index",
  method: "POST",
  task_class: "TaxRateExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_TAX_RATE_EXPORT",
  useSelection: true,
  useIndex: true
};

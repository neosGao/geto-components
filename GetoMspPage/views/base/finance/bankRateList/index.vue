 ...
 * @FilePath: src\geto-components\GetoMspPage\views\base\finance\bankRateList\index.vue
 * @Description: 银行利率列表-列表
 *
...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/bankRateList";
...
const init_data_config = {
  title: "银行利率列表",
  url: "/api/msp-helper/publicbasicdata/bank-rate/index",
  method: "POST",
  task_class: "BankRateExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_BANK_RATE_EXPORT",
  useSelection: true,
  useIndex: true
};

...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/taxSystemList";
...
const init_data_config = {
  title: "税收制度",
  url: "/api/msp-helper/publicbasicdata/tax-system/index",
  method: "POST",
  task_class: "TaxSystemExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_TAX_SYSTEM_EXPORT",
  useSelection: true,
  useIndex: true
};

...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/taxTypesList";
...
const init_data_config = {
  title: "税收列表",
  url: "/api/msp-helper/publicbasicdata/tax-types/index",
  method: "POST",
  task_class: "TaxTypesExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_TAX_TYPES_EXPORT",
  useSelection: true,
  useIndex: true
};

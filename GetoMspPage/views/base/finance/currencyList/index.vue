 ...
 * @FilePath: src\geto-components\GetoMspPage\views\base\finance\currencyList\index.vue
 * @Description: 币别维护-列表
 *
...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/currencyList";
...
const init_data_config = {
  title: "币别维护",
  url: "/api/msp-helper/publicbasicdata/currency/index",
  method: "POST",
  task_class: "CurrencyListExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_CURRENCY_MANAGEMENT_EXPORT",
  useSelection: true,
  useIndex: true
};

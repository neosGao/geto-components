...
const init_data_config = {
  title: "港口信息维护",
  url: "/api/msp-helper/publicbasicdata/ship-harbor/index",
  method: "POST",
  task_class: "ShipHarborExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_SHIP_HARBOR_EXPORT",
  info_permission: "PAGE_BASIC_SHIP_HARBOR",
  useSelection: true,
  useIndex: true
};

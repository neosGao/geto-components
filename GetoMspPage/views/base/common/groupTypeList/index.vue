...
import {
  ...
  exportList,
  sync
} from "@/geto-components/GetoMspPage/api/base/groupTypeList";
...
const init_data_config = {
  title: "组别类型管理",
  url: "/api/msp-helper/publicbasicdata/group-type/index",
  method: "POST",
  task_class: "GroupTypeExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_BASIC_GROUP_TYPE_EXPORT",
  useSelection: true,
  useIndex: true
};

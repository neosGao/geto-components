<template>
  <div class="dark:text-white geto-search-table">
    <GetoTabs
      :params="view_conf"
      searchAuth="OPERATE_DISTANCE_MAINTAIN_SEARCH"
      @onSearch="onSearch"
      :defaultTab="tabName"
    />
    <GetoTable
    ...
    >
      <template v-slot:button-row>
        <!-- 按钮位置插槽 -->
        <el-button
          v-auth="'OPERATE_DISTANCE_MAINTAIN_SYNC'"
          @click="handleSync"
        >
          同步
        </el-button>
...
const init_data_config = {
  title: "物流运输距离",
  url: "/api/msp-helper/publicbasicdata/distance-maintain/index",
  method: "POST",
  task_class: "DistanceExcelExport",
  export_func: exportList,
  export_permission: "OPERATE_DISTANCE_MAINTAIN_EXPORT",
  info_permission: "OPERATE_DISTANCE_MAINTAIN_EXPORT",
  useSelection: true,
  useIndex: true
};

<template>
  <div class="dark:text-white geto-search-table">
    <GetoTabs
      :params="view_conf"
      searchAuth="OPERATE_PERMISSION_OPERATE_MANAGE_SEARCH"
      @onSearch="onSearch"
    />
    <GetoTable
      ref="getoTable"
    ...
    >
      <template v-slot:button-row>
        ...
        <SyncBtn
          @onSearch="onSearch"
          v-auth="'OPERATE_PERMISSION_OPERATE_MANAGE_SYNC'"
        />
      </template>
    </GetoTable>
  </div>
...
import {
  getListPageConf,
  exportList
} from "@/geto-components/GetoMspPage/api/operate-manage";
...
const init_data_config = {
  title: "操作权限列表",
  url: "/api/msp-helper/permission/operate-manage/list",
  method: "POST",
  task_class: "OperateListExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_PERMISSION_OPERATE_MANAGE_EXPORT",
  info_permission: "OPERATE_PERMISSION_OPERATE_MANAGE_INFO",
  useIndex: true
};

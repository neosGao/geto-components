<template>
  <div class="dark:text-white geto-search-table">
    <GetoTabs
      :params="view_conf"
      searchAuth="OPERATE_ROLE_PERMISSION_STATEMENT_SEARCH"
      @onSearch="onSearch"
    />
    <GetoTable
      ref="getoTable"
...
import {
  getListPageConf,
  exportList
} from "@/geto-components/GetoMspPage/api/role-permission-statement";
...
const init_data_config = {
  title: "角色权限报表",
  url: "/api/msp-helper/permission/role-permission-statement/list",
  method: "POST",
  task_class: "RolePermissionExcelExportTask",
  export_func: exportList,
  export_permission: "OPERATE_ROLE_PERMISSION_STATEMENT_EXPORT",
  useSelection: true,
  useIndex: true
};

  ...
  <div class="geto-tree">
    <div class="mb-1">
      ...
      <el-input
        ...
        readonly
      ></el-input>
      <el-input v-else placeholder="请先同步数据" readonly></el-input>
    </div>
...
const emits = defineEmits(["handleNodeClick", "handleCheckChange", "handleDisplayLowerLevelChange"]); // 定义发射给父组件的事件
